document.addEventListener("DOMContentLoaded", function(event) {
    (function () {
        ...
        function showQRCode(invoice, options)
        {
            ...
            <div style="text-align:center; padding-top: 10px"><small>Lightning Payment Processor</small><br><a href="https://lightningcheckout.eu"><img src="/wp-content/plugins/bitcoin-lightning-publisher/assets/img/logo-lightningcheckout.png" height="25"></a>
            </div>`;
        }
